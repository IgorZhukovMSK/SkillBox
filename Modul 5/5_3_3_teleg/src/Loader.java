...
public class Loader {
    public static void main(String[] args) throws IOException {
       ...
       AuthAuthorization authSignIn = bridge.authSignIn(reader.readLine());
        ...
        ArrayList<UserContact> importContacts = bridge.contactsGetContacts();
        //String Contact = importContacts;
        for (contact : importContacts.size()){
        System.out.println("Контакты: " + importContacts);
    }

    //private static class AuthSentSms {
    }
